# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-08-23 07:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('members', '0021_campaigntag_display_order'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='url_parameters', to='members.UpdateDetailsCampaign')),
            ],
        ),
    ]
